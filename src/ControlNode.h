...
private:
	...
	ros::Publisher manualScalePublisher;
	ros::Publisher manualKeyframePublisher;
	...
	std::string	noCommandsChannel;
	std::string manualScaleChannel;
	std::string manualKeyframeChannel;
...
public:
	...
	void manualScaleActivate(bool start);
	...
	bool autonomousDiscovery;
	bool sentNoCommandMessage;

	bool visionLost;

	ros::Time lastLagTime;
	int numLags;
	bool compensateLag;
	ros::Time goBackTime;

	bool visionHadOnce;
	bool didLagHappenedProd;

	KIProcedure *goBackKI;
